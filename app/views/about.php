...
<section id="about-head" class="section-p1">
    ...
    <div>
        <h2>Who We Are?</h2>
        <P>Lorem ipsum dolor dit amet.consectetur adipisicing elit.sed 
            eiusmod tempor incididunt ut labore et dolore magna ut 
            enim ad minim veniam.quis nostrud exercitation ullamco lavoris
            nisi ut aliquip ex ea commodo consequat.Duis auteirure dolor in 
            reprehenderit in voluptate velir esse cillum dolore fugiat nulla 
            pariatur. Excepteur sint occaecat cupisatal non proident.sunt in 
            culpa qui sfficia deserunt molit anim id est laborum.</P>
       ...
       <marquee bgcolor="#ccc" loop="-1" scrollamount="5" width="100%">reate stunning images with as much or as little control as you 
