...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= APP_ASSETS ?>css/pages/page-misc.css">
    <!-- END: Page CSS-->
                ...
                <div class="misc-wrapper"><a class="brand-logo" href="index.html">
                    ...
                    <div class="misc-inner p-2 p-sm-3">
                        <div class="w-100 text-center">
                            <h2 class="mb-1">Your Account Is Under Review</h2>
                            <p class="mb-2">
                                Your account has been created successfully , but the admin hasn't accepted your partnership yet , please check it later 😫
                            </p><a class="btn btn-primary mb-1 btn-sm-block" href="<?=ROOT?>admin/logout">Go to login page</a><img class="img-fluid" src="<?= APP_ASSETS ?>images/pages/not-authorized-dark.svg" alt="Not authorized page" />
                        </div>
                    </div>
                </div>
                <!-- / Not authorized-->
