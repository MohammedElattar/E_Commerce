...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="index.html" class="brand-logo">
                                    ...
                                    <h2 class="brand-text text-primary ms-1">Admin Portal</h2>
                                </a>

                                <h4 class="card-title mb-1">Welcome to Admin Portal 👋</h4>
                                <p class="card-text mb-2">Please sign-in to your account and start the adventure</p>
                                <div class="errors d-flex justify-content-center flex-wrap">
                                    <div class="alert alert-danger text-center not-exists" style="width:100%;padding:10px;margin-right:.5%;display:none;">This Account Not Exists</div>
                                    <div class="alert alert-success text-center success" style="width:100%;padding:10px;margin-right:.5%;display:none;">Logged In Successfully</div>
                                </div>
                                <form class="auth-login-form mt-2" action="<?= ROOT ?>ajax/login" onsubmit="login(event)" method="POST">
                                    <div class="mb-1">
                                    ...
                                    <button class="btn btn-primary w-100 login-btn" tabindex="4">Sign in</button>
                                </form>

                                <p class="text-center mt-2">
                                    <span>New on our platform?</span>
                                    <a href="<?= ROOT ?>admin/signup">
                                ...
                                <div class="auth-footer-btn d-flex justify-content-center">
                                    <a href="<?= ROOT ?>admin/authGoogle" link="<?= ROOT ?>ajax/login?m=google" class="btn btn-google">
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?= APP_ASSETS ?>js/scripts/pages/auth-login.js"></script>
    <!-- END: Page JS-->
