...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= APP_ASSETS ?>vendors/css/forms/wizard/bs-stepper.min.css">
    ...
    <link rel="stylesheet" type="text/css" href="<?= APP_ASSETS ?>css/plugins/forms/form-wizard.css">
    <link rel="stylesheet" type="text/css" href="<?= APP_ASSETS ?>css/plugins/forms/form-validation.css">
    <link rel="stylesheet" type="text/css" href="<?= APP_ASSETS ?>css/pages/authentication.css">
    <!-- END: Page CSS-->
...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                    ...
                    <div class="auth-inner row m-0">
                        ...
                        <div class="col-lg-3 d-none d-lg-flex align-items-center p-0">
                            <div class="w-100 d-lg-flex align-items-center justify-content-center">
                                <img class="img-fluid w-100" src="<?= APP_ASSETS ?>images/illustration/create-account.svg" alt="multi-steps" />
                            </div>
                        </div>
                        <!-- /Left Text-->
                                ...
                                <div class="bs-stepper register-multi-steps-wizard shadow-none">
                                    ...
                                    <div class="bs-stepper-content px-0 mt-4">
                                        <div id="account-details" class="content" role="tabpanel" aria-labelledby="account-details-trigger">
                                            <div class="errors d-flex justify-content-center flex-wrap">
                                                <div class="alert alert-danger text-center valid-username" style="width:49.5%;padding:10px;margin-right:.5%;display:none;">Enter Valid Username</div>
                                                <div class="alert alert-danger text-center valid-email" style="width:49.5%;padding:10px;margin-right:.5%;display:none;">Enter Valid Email</div>
                                                <div class="alert alert-danger text-center username-exists" style="width:49.5%;padding:10px;margin-right:.5%;display:none;">Username is Already Exists</div>
                                                <div class="alert alert-danger text-center email-exists" style="width:49.5%;padding:10px;margin-right:.5%;display:none;">Email is Already Exists</div>
                                            </div>
                                        ...
                                        <div class="errors d-flex justify-content-center flex-wrap">
                                                <div class="alert alert-danger text-center valid-first-name" style="width:49.5%;padding:10px;margin-right:.5%;display:none;">First Name Must Contains Only Characters</div>
                                                <div class="alert alert-danger text-center valid-last-name" style="width:49.5%;padding:10px;margin-right:.5%;display:none;">First Name Must Contains Only Characters</div>
                                                <div class="alert alert-danger text-center valid-phone" style="width:49.5%;padding:10px;margin-right:.5%;display:none;">Phone Number Must Have 11 digits</div>
                                                <div class="alert alert-success text-center success" style="width:49.5%;padding:10px;margin-right:.5%;display:none;">Your Account Has Been Created Successfully</div>
                                            </div>
                                            <div class="content-header mb-2">
    ...
    <script src="<?= APP_ASSETS ?>vendors/js/forms/wizard/bs-stepper.min.js"></script>
    ...
    <!-- BEGIN: Page JS-->
    <script src="<?= APP_ASSETS ?>js/scripts/pages/auth-register.js"></script>
    <!-- END: Page JS-->
