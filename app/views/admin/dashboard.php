          ...
          <div class="row match-height">
            ...
            <div class="col-xl-4 col-md-6 col-12">
              <div class="card card-congratulation-medal">
                <div class="card-body">
                  <h5>Congratulations 🎉 <?= $_SESSION['data']['first_name'] ?>!</h5>
                  ...
                  <img src="<?= APP_ASSETS ?>images/illustration/badge.svg" class="congratulation-medal" alt="Medal Pic" />
                </div>
              </div>
            </div>
            <!--/ Medal Card -->
                          ...
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="avatar rounded">
                                <div class="avatar-content">
                                  <img src="<?= APP_ASSETS ?>images/icons/toolbox.svg" alt="Toolbar svg" />
                                </div>
                              </div>
                              <div>
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="avatar rounded">
                                <div class="avatar-content">
                                  <img src="<?= APP_ASSETS ?>images/icons/parachute.svg" alt="Parachute svg" />
                                </div>
                              </div>
                              <div>
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="avatar rounded">
                                <div class="avatar-content">
                                  <img src="<?= APP_ASSETS ?>images/icons/brush.svg" alt="Brush svg" />
                                </div>
                              </div>
                              <div>
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="avatar rounded">
                                <div class="avatar-content">
                                  <img src="<?= APP_ASSETS ?>images/icons/star.svg" alt="Star svg" />
                                </div>
                              </div>
                              <div>
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="avatar rounded">
                                <div class="avatar-content">
                                  <img src="<?= APP_ASSETS ?>images/icons/book.svg" alt="Book svg" />
                                </div>
                              </div>
                              <div>
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="avatar rounded">
                                <div class="avatar-content">
                                  <img src="<?= APP_ASSETS ?>images/icons/rocket.svg" alt="Rocket svg" />
                                </div>
                              </div>
                              <div>
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center">
                              <div class="avatar rounded">
                                <div class="avatar-content">
                                  <img src="<?= APP_ASSETS ?>images/icons/speaker.svg" alt="Speaker svg" />
                                </div>
                              </div>
                              <div>
...
?>
<!-- BEGIN: Page JS-->
<script src="<?= APP_ASSETS ?>js/scripts/pages/dashboard-ecommerce.js"></script>
<!-- END: Page JS-->